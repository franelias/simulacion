...
equation
  ...
  model Ejemplo1
    SliderCrank bielaManivela annotation(
  ...
  equation
    ...
    annotation(
      Diagram(graphics),
      Icon(graphics = {Polygon(fillColor = {255, 255, 255}, fillPattern = FillPattern.Solid, points = {{-100, 50}, {100, -50}, {100, 50}, {0, 0}, {-100, -50}, {-100, 50}}), Line(origin = {0, 1}, points = {{-100, 1}, {100, -1}, {100, -1}}), Polygon(origin = {80, -1}, points = {{-4, 9}, {-4, -7}, {4, 1}, {4, 1}, {-4, 9}}), Text(origin = {0, 14}, textColor = {0, 0, 255}, extent = {{-150, 90}, {150, 50}}, textString = "%name"), Text(origin = {0, -28}, extent = {{-138, -20}, {138, -40}}, textString = "Ron=%Ron"), Text(origin = {0, -58}, extent = {{-138, -20}, {138, -40}}, textString = "Roff=%Roff")}));
end CheckValve;
  ...
  model AspirantImpelentBomb
    ...
    DSFLib.Mechanical.Rotational.Interfaces.Flange flange annotation(
      Placement(transformation(origin = {-90, 2}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}})));
    DSFLib.Hydraulics.Interfaces.FluidPort fluidInput annotation(
      Placement(transformation(origin = {52, -36}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {20, -100}, extent = {{-10, -10}, {10, 10}})));
    DSFLib.Hydraulics.Interfaces.FluidPort fluidOutput annotation(
      Placement(transformation(origin = {52, 72}, extent = {{-10, -10}, {10, 10}}), iconTransformation(origin = {20, 102}, extent = {{-10, -10}, {10, 10}})));
    CheckValve checkValve1 annotation(
  ...
  equation
    ...
    annotation(
      Icon(graphics = {Line(origin = {-24.7941, 10.2415}, points = {{44.7941, 89.7585}, {-75.2059, -10.2415}, {44.7941, -110.242}, {44.7941, 51.7585}, {44.7941, 89.7585}}), Line(origin = {-6, 5.2042}, points = {{0, -33.2042}, {0, 22.7958}, {-10, 10.7958}, {10, 10.7958}, {0, 22.7958}, {0, 22.7958}})}),
  Diagram(graphics));
end AspirantImpelentBomb;

  model Ejemplo3
    AspirantImpelentBomb aspirantImpelent1 annotation(
      Placement(transformation(origin = {19, -1}, extent = {{-11, -11}, {11, 11}})));
    DSFLib.Mechanical.Rotational.Components.Inertia inertia annotation(
  ...
  model SistemaCompleto
    ...
    AspirantImpelentBomb aspirantImpelent1 annotation(
      Placement(transformation(origin = {-8, -18}, extent = {{-16, -16}, {16, 16}})));
    DSFLib.Hydraulics.Components.ConstPress constPress annotation(
      Placement(transformation(origin = {-22, -60}, extent = {{-10, -10}, {10, 10}})));
